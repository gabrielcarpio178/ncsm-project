...
<main class="w-[86.6%] absolute top-40 left-64 p-20 flex flex-col gap-y-8 z-0">
    <div class="flex justify-between mx-40">
        ...
        <button class="w-20 h-10 bg-[#168753] rounded-md text-white hover:bg-green-900" type="submit">Print</button>
    </div>
    <div class="shadow-md rounded-lg bg-white mx-80 px-20 py-10">
        ...
        @if ($student->status===false)
            <div class="flex flex-row w-full justify-center mt-10 gap-x-10">
                <button class="w-20 h-10 bg-[#168753] rounded-md text-white hover:bg-green-900" type="submit">Accept</button>
                <button class="w-20 h-10 bg-red-700 rounded-md text-white hover:bg-red-900" type="submit">Decline</button>
            </div>
        @endif
